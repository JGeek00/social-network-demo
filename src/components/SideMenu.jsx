...
const SideMenu = ({optionsMenuOpen, openOptionsMenu, openLogoutModal, selectedPage, name, sideMenuOpen, handleMenuOpen}) => {
    return (
        <React.Fragment>
            <div className={sideMenuOpen === true ? "sideMenuBase sideMenuOpen" : "sideMenuBase"} onClick={handleMenuOpen}></div>
            <div className={sideMenuOpen === true ? "sideMenu sideMenuCollapsable" : "sideMenu sideMenuCollapsable sideMenuClosed"}>
